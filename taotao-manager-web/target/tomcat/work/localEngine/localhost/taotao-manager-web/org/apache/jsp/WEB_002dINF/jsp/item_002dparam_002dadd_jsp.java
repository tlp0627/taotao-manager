...
public final class item_002dparam_002dadd_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    try {
      ...
      out.write("\t\t\t  $.getJSON(\"/taotao-manager-web/item/param/query/itemcatid/\" + node.id,function(data){\r\n");
      ...
      out.write("\t\t\t\t}\r\n");
      out.write("\t\t\t});\r\n");
      out.write("\t\t\tvar url = \"/taotao-manager-web/item/param/save/\"+$(\"#itemParamAddTable [name=cid]\").val();\r\n");
